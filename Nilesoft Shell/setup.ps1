...
# ---------------------------------------------------------------------------- #
#  Nilesoft Shell Setup Function
function SetupNilesoftShell {
    try {
        $Shell    = [System.IO.Path]::Combine($Global:WinfigPaths.Templates, "Nilesoft Shell", "shell.nss")
        $Themes   = [System.IO.Path]::Combine($Global:WinfigPaths.Templates, "Nilesoft Shell", "themes")
        $Imports  = [System.IO.Path]::Combine($Global:WinfigPaths.Templates, "Nilesoft Shell", "imports")
        $Scripts  = [System.IO.Path]::Combine($Global:WinfigPaths.Templates, "Nilesoft Shell", "scripts")
        $target   = [System.IO.Path]::Combine($env:ProgramFiles, "Nilesoft Shell")
        ...
        Show-ErrorMessage "Failed to setup Nilesoft Shell configuration: $($_.Exception.Message)"
        Log-Message -Message "Failed to setup Nilesoft Shell configuration: $($_.Exception.Message)" -Level "ERROR"
    }
}
...
Winfig-Banner
Write-SectionHeader -Title "Setup Nilesoft Shell Configuration"
